...
.footer { text-align: center; padding: 20px; color: #666; font-size: 12px; }
  ...
  async sendPasswordResetEmail(email, name, resetUrl) {
    const subject = 'إعادة تعيين كلمة المرور - MirhalGO Password Reset';
    const html = `
      <!DOCTYPE html>
      <html dir="rtl" lang="ar">
      <head>
        ...
        <style>
          ...
          .reset-button { display: inline-block; padding: 14px 32px; background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 700; font-size: 16px; box-shadow: 0 4px 6px rgba(239, 68, 68, 0.3); }
          .warning-box { background-color: #fef3c7; border-right: 4px solid #f59e0b; padding: 16px; border-radius: 8px; margin: 20px 0; }
          .warning-text { color: #92400e; margin: 0; font-weight: 600; font-size: 14px; }
          .footer { background-color: #f9fafb; padding: 24px; text-align: center; border-top: 1px solid #e5e7eb; color: #6b7280; font-size: 13px; }
          .link { color: #4f46e5; text-decoration: none; font-weight: 600; word-break: break-all; }
        </style>
      </head>
      <body>
        <div class="wrapper">
          <table class="main-table" align="center" dir="rtl">
            ...
            <tr>
              <td class="content">
                <div class="greeting">مرحباً ${name} 👋</div>
                <p>تلقينا طلباً لإعادة تعيين كلمة المرور لحسابك في منصة <strong>مرحال جو</strong>.</p>
                ...
                <div class="warning-box">
                  <p class="warning-text">⚠️ هذا الرابط صالح لمدة ساعة واحدة فقط</p>
                </div>

                <p>إذا لم تقم بطلب إعادة تعيين كلمة المرور، يمكنك تجاهل هذا البريد الإلكتروني بأمان. لن يتم تغيير كلمة المرور الخاصة بك.</p>

                <p style="margin-top: 30px; font-size: 14px; color: #6b7280;">إذا لم يعمل الزر، انسخ والصق الرابط التالي في متصفحك:</p>
                <p style="font-size: 13px;"><a href="${resetUrl}" class="link">${resetUrl}</a></p>
              </td>
            </tr>
