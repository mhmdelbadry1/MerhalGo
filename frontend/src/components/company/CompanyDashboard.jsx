  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const available = availableResp.data?.data || availableResp.data || [];
        const offers = offersResp.data?.data || offersResp.data || [];
        const myOrders = myOrdersResp.data?.data || myOrdersResp.data || [];
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Contact Us Section */}
        <div className="mt-12 bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-md text-center">
