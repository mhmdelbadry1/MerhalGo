  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button
          onClick={loadOrders}
          className="w-full sm:w-auto px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
        >
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-right">
              <thead className="bg-gray-50 dark:bg-gray-700 border-b border-gray-100 dark:border-gray-600">
                <tr>
                  <th className="px-3 sm:px-6 py-3 sm:py-4 text-gray-600 dark:text-gray-300 font-semibold text-xs sm:text-sm">الإجراءات</th>
                  <th className="px-3 sm:px-6 py-3 sm:py-4 text-gray-600 dark:text-gray-300 font-semibold text-xs sm:text-sm">الحالة</th>
                  <th className="px-3 sm:px-6 py-3 sm:py-4 text-gray-600 dark:text-gray-300 font-semibold text-xs sm:text-sm hidden md:table-cell">العنوان</th>
                  <th className="px-3 sm:px-6 py-3 sm:py-4 text-gray-600 dark:text-gray-300 font-semibold text-xs sm:text-sm">العميل</th>
                  <th className="px-3 sm:px-6 py-3 sm:py-4 text-gray-600 dark:text-gray-300 font-semibold text-xs sm:text-sm hidden sm:table-cell">النوع</th>
                  <th className="px-3 sm:px-6 py-3 sm:py-4 text-gray-600 dark:text-gray-300 font-semibold text-xs sm:text-sm">رقم الطلب</th>
                </tr>
              </thead>
